  ...
  if (!isOpen) {
    return (
      <motion.button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-purple-600 to-indigo-600 text-white rounded-full shadow-2xl flex items-center justify-center transition-all z-50 border border-white/20"
      >
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-6 right-6 w-[400px] bg-white/90 backdrop-blur-xl rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] flex flex-col z-50 overflow-hidden border border-white/30"
      >
        {/* Header */}
        <div className="p-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white flex items-center justify-between shadow-lg relative overflow-hidden">
