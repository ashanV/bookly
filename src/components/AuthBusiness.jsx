...
import { ChevronRight, ChevronLeft, Check, Building2, User, Mail, Phone, MapPin, Briefcase, Clock, Calendar, DollarSign, Users, Star, Image, Globe, Instagram, Facebook, Camera } from 'lucide-react';
...
const BooklyAuth = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('🎉 Gratulacje! Rejestracja ukończona pomyślnie!');
  ...
  const isStepValid = () => {
    ...
    if (step === 5) return formData.acceptTerms;
    return false;
  };
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-700 p-10 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-purple-100 text-lg">Rozwijaj swoją firmę z najlepszym systemem rezerwacji</p>
          </div>
        </div>
              ...
              <React.Fragment key={num}>
                <div className="flex flex-col items-center">
                  ...
                  <span className={`text-xs mt-2 font-medium text-center ${step >= num ? 'text-purple-600' : 'text-gray-400'}`}>
                    {num === 1 ? 'Firma' : num === 2 ? 'Dane' : num === 3 ? 'Lokalizacja' : num === 4 ? 'Usługi' : 'Podsumowanie'}
                  </span>
                </div>
                {num < 5 && (
          ...
          {step === 5 && (
            <div className="space-y-6 animate-fadeIn">
              <div className="bg-purple-50 border-l-4 border-purple-600 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600">Prawie gotowe! Sprawdź swoje dane</p>
              </div>
