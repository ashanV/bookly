...
export default function AddEmployeePage() {
        ...
        if (user?.id) {
            try {
                ...
                if (response.ok) {
                    ...
                    if (business.employees) setExistingEmployees(business.employees);
    ...
    const handleAvatarUpload = async (e) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                setNewEmployee(prev => ({ ...prev, avatarImage: reader.result }));
            };
            ...
            if (url) {
                setNewEmployee(prev => ({ ...prev, avatarImage: url }));
    ...
    const handleSave = async () => {
        ...
        const updatedEmployees = [...existingEmployees, employeeToAdd];

        // Normalization logic from TeamPage
        ...
        try {
            ...
            if (response.ok) {
                ...
                const data = await response.json();
                toast.error(data.error || 'Błąd dodawania pracownika');
            }
        } catch (error) {
        ...
        <div className="flex flex-col h-[calc(100vh-64px)] overflow-hidden bg-white">
            ...
            <div className="flex justify-between items-center px-8 py-4 border-b border-gray-100 bg-white z-10">
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-xl font-bold text-gray-900">Dodaj pracownika</h2>
                </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-12 mb-8">
                                ...
                                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            value={newEmployee.name?.split(' ').slice(1).join(' ') || ''}
                                            onChange={(e) => {
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {CALENDAR_COLORS.map((color) => (
                                        <button
                                            key={color}
                                            className={`w-10 h-10 rounded-full transition-transform hover:scale-110 ${newEmployee.calendarColor === color ? 'ring-2 ring-offset-2 ring-black' : ''
                                                }`}
