...
export default function CRMPage() {
    const t = useTranslations('BusinessClients');
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    <div>
                        <div className="flex items-center gap-3 mb-1">
                            <h2 className="text-2xl font-bold text-slate-900">{t('listTitle')}</h2>
                            <span className="bg-slate-100 text-slate-600 text-sm font-medium px-2.5 py-0.5 rounded-full">
                                {clientCount}
                            </span>
                        </div>
                        <p className="text-slate-500">{t('description')} <span className="text-violet-600 cursor-pointer hover:underline">{t('learnMore')}</span></p>
                    </div>
